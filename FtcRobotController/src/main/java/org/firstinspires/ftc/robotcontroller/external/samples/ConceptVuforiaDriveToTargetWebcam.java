...
public class ConceptVuforiaDriveToTargetWebcam extends LinearOpMode
{
    ...
    final double SPEED_GAIN =   0.03 ;   //  Speed Control "Gain". eg: Ramp up to 50% power at a 25 inch error.   (0.50 / 25.0)
    final double TURN_GAIN  =   0.02 ;   //  Turn Control "Gain".  eg: Ramp up to 25% power at a 25 degree error. (0.25 / 25.0)

    final double MM_PER_INCH = 25.40 ;   //  Metric conversion from imperial to metric
